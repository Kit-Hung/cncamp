...
func (b Factory) Bg() BaseLogger {
	return wrapper(b)
}

// For returns a context-aware BaseLogger. If the context
// contains a span, all logging calls are also
// echo-ed into the span.
func (b Factory) For(ctx context.Context) BaseLogger {
